    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_accepted",
                    models.IntegerField(
                        choices=[(0, b"no"), (1, b"with penalization"), (2, b"yes")],
                        default=2,
                    ),
                ),
            ],
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="submit.SubmitReceiver"
            ),
        ),
        migrations.AddField(
            model_name="submit",
        ...
        migrations.AddField(
            ...
            name="submit",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="submit.Submit"
            ),
        ),
    ]
